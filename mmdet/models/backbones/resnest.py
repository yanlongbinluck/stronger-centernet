...
class ResNest(nn.Module):
    ...
    def forward(self, x): # [1, 3, 224, 224] 
        ...
        outs = []
        x = self.layer1(x) # [1, 256, 56, 56]  4X downsample
        outs.append(x)
        x = self.layer2(x) # [1, 512, 28, 28]  8X downsample
        outs.append(x)
        x = self.layer3(x) # [1, 1024, 14, 14] 16X downsample
        outs.append(x)
        x = self.layer4(x) # [1, 2048, 7, 7]   32X downsample
        outs.append(x)
...
# # print requires_grad
# model.init_weights(pretrained='C:/Users/Yan Longbin/.cache/torch/hub/checkpoints/resnest50-528c19ca.pth')
...
# with open('C:/Users/Yan Longbin/Desktop/resnest/imagenet_class_index.json', 'r') as f:
#     load_dict = json.load(f)

# inp = cv2.imread('C:/Users/Yan Longbin/Desktop/resnest/truck.jpg') / 255. # [H,W,3]
